...
Get a list of category IDs that are related to MTG
```{r}
magicids <- select(categories.tibble, categoryId, displayName)
magicids  <- filter(magicids, displayName == "Magic: The Gathering")[,0, drop=TRUE]

```

Great! Now we have a list of category IDs that are related to MTG - let's use those values to get the rest of the data we want. 
